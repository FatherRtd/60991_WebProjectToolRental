    ...
    <header class="container">
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-black" style="min-height: 70px">
            <div class="container-fluid">
                <a class="navbar-brand" href="http://toolrental/index.php?page=prod">ToolRental</a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?page=cat">Категории</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?page=prod">Инструменты</a>
                        </li>
                    </ul>
